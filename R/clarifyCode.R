#' LLM: Clarify Code
#'
#' @param code The code to be explained by LLM. If not provided, it will use what's copied on
#'   the clipboard.
...
#' @examples
#' \dontrun{
#' cat(clarifyCode("z <- function(x) scale(x)^2"))
#' }
#'
...
#' @export
#'
clarifyCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
  ...
  prompt <- paste0('Explain the following code: "', code, '"')
