#' LLM: Find Issues in Code
#'
#' @param code The code to be analyzed by LLM. If not provided, it will use what's copied on
#'   the clipboard.
...
#' @examples
#' \dontrun{
#' cat(debugCode("z <- function(x) scale(x)2)")
#' }
#'
...
#' @export
#'
debugCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
