#' LLM: Finish code
#'
#' @param code The code to be completed by LLM. If not provided, it will use what's copied on
#'  the clipboard.
...
#' @examples
#' \dontrun{
#' cat(finishCode("# A function to square each element of a vector\nsquare_each <- function("))
#' }
#'
...
#' @export
#'
finishCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
