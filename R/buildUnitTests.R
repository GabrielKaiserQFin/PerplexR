#' LLM: Create Unit Tests
#'
#' Create `{testthat}` test cases for the code.
#'
#' @param code The code for which to create unit tests by LLM. If not provided, it will use
...
#' @examples
#' \dontrun{
#' cat(buildUnitTests("squared_numbers <- function(numbers) {\n  numbers ^ 2\n}"))
#' }
#'
...
#' @export
#'
buildUnitTests <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
  ...
  prompt <- paste0('Using testthat 3e, version over 3.0.0, create a full testthat file, with test cases for the following R code: "', code, '"')
