#' LLM: Optimize Code
#'
#' @param code The code to be optimized by LLM. If not provided, it will use what's copied on
#'   the clipboard.
...
#' @examples
#' \dontrun{
#' cat(optimizeCode("z <- function(x) scale(x)^2"))
#' }
#'
...
#' @export
#'
optimizeCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
