#' LLM: Annotate code
#'
#' @param code The code to be commented by LLM. If not provided, it will use what's copied on the clipboard.
...
#' @examples
#' \dontrun{
#' cat(annotateCode("z <- function(x) scale(x)^2"))
#' }
#'
...
#' @export
#'
annotateCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE),
  ...
  prompt <- paste0('Add very short inline comments to the following code without altering the code starting with a `#`: "', code, '"')
