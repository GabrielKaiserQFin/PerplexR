#' LLM: Code Documentation (roxygen2 style)
#'
#' @param code The code to be documented by LLM. If not provided, it will use what's copied on
#'   the clipboard.
#' @param inLineDocumentation Formatting style of In-Line Documentation.
...
#' @examples
#' \dontrun{
#' cat(documentCode("z <- function(x) scale(x)^2"))
#' }
#'
...
#' @export
#'
documentCode <- function(code = clipr::read_clip(allow_non_interactive = TRUE), inLineDocumentation = "roxygen2",
  ...
  prompt <- paste0('Conduct an In-Line Documentation using ", inLineDocumentation, " format for this function: "', code, '"')
